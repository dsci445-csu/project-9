...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/sii_barplot.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/sds_boxplot.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/dealingWithNAs.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/predicted_sds_plot.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/ridge_plot.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/rf_plot_1.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/rf_plot_2.png")
```
...
```{r}
include_graphics("C:/Users/natha/OneDrive/Pictures/Screenshots/Screenshot 2024-11-29 142953.png")
```
...
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/nathan/Linear Discriminant Analysis/Plots/LDA_test_confmat.png")
```
...
```{r, eval = TRUE, echo= FALSE, message = FALSE, warning = FALSE}
include_graphics("C:/Users/natha/OneDrive/Documents/project-9/nathan/Linear Discriminant Analysis/Plots/lda_plot_naRm.png")
```
