...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
# W/L Distribution
# df = read.csv("d2_250_performance.csv")
ggplot(df, aes(x = win)) +
...
summary(df[, c("deaths", "kills", "dragonKills", "baronKills", "firstBloodKill", "firstBloodAssist")])
```
Based on the Win/Loss Distribution graph, it is clear that this dataset is almost perfectly balanced, and not heavily scewed towards either Win or Loss.
