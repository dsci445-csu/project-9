...
ggplot(df, aes(x = win)) +
  ...
  labs(title = "Win/Loss Distribution",
       ...
       y = "Count")
```
Based on the Win/Loss Distribution graph, it is clear that this dataset is not heavily scewed towards Wins or Losses, yet it's almost perfectly balanced.
