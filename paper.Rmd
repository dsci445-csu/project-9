...
author: "Ryan Stevens, Elle Isabel Angell, Nick Li, Coleman Garnier"
output:
...
The data was explored first by the distribution of wins and losses, examining variables that were selected for our SVM model, and analzying the impact of gold earned on game outcome. This helps identify features that have potential to be strong predictors for game outcome.
